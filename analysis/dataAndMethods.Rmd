...
1.  Mapping of secured areas 
    * Projected to LANDFIRE projection
    * Converted from vector to raster (matched LANDFIRE cell size)
    * Used extract by attributes to create one raster for each or our example landscapes.  We used the relevant values from the VALUE field for extraction. 
...
## Data analysis (see code for details)
